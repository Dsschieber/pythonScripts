# -*- coding: utf-8 -*-
#
# mVec documentation build configuration file, created by
...
project = u'mMath'
copyright = u'2015, Marco Giordano'
...
latex_documents = [
  ('index', 'mVec.tex', u'mVec Documentation',
   u'Marco Giordano', 'manual'),
]
